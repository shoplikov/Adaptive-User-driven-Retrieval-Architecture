...
def main():
    ...
    try:
        ...
        if os.path.exists(env_path):
            ...
            logger.info(f"ANALYTICS_DATABASE_URL: {os.getenv('ANALYTICS_DATABASE_URL')}")
        ...
        subprocess.check_call([sys.executable, "-m", "uvicorn", "main.app:app", "--host", "0.0.0.0", "--port", "8001"])
